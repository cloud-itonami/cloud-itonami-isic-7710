# Operator Quickstart — Community Vehicle Rental Operations

Shortest path from clone to a verified local dry-run for **ISIC 7710** (`cloud-itonami-isic-7710`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-7710.git
cd cloud-itonami-isic-7710
```
...
- Blueprint governor key: `vehicle-rental-governor`
- Likely source path: `src/**/vehicle-rental-governor.cljc`
